    ...
    def train(self):
        ...
        while not out:
            for x,y in self.data_loader:
                ...
                for index in range(self.z_dim):
                    if index not in self.sequence and dim_wise_kld[index] > 0.5:
        ...
        for key in Z.keys():
            ...
            for row in range(self.z_dim):
                ...
                for val in interpolation:
                    ...
                    gifs.append(sample)
            llr = z[0][9] + z[0][8] + z[0][2] + z[0][1] - z[0][0] - z[0][6] - z[0][5] - z[0][3]
            print(key, llr.item())
